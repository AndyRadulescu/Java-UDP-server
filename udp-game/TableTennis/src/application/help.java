...
public class help extends Application implements Sizes, Runnable {
    ...
    public help() throws SocketException {
    }
    ...
    private void set(String message) {
        ...
        this.rect1.setTranslateY(Double.parseDouble(parts[0]));
        this.rect2.setTranslateY(Double.parseDouble(parts[1]));
        this.ball.setCenterX(Double.parseDouble(parts[2]));
        this.ball.setCenterY(Double.parseDouble(parts[3]));
            ...
            if (e.isPrimaryButtonDown()) {
                if (e.getSceneY() < mousePointer) {
                    if (rect2.getTranslateY() != 0) {
                        ...
                        rect2.setTranslateY(e.getSceneY());
                    }
